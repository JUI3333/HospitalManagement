INSERT INTO patient(patient_name, gender, birth_date, email, blood_group)
VALUES
...
VALUES
('Dr. Nidhi Sonawane','Cardiology','nidhi.sonawane@example.com'),
('Dr. Khushi Munot','Dermatology','khushi.munot@example.com'),
('Dr. Aditya Solunke','Orthopedics','aditya.solunke@example.com');
